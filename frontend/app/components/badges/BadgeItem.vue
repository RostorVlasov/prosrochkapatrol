<template>
    <div class="p-4 dark:bg-gray-700 bg-gray-300/50 rounded-xl">
        ...
        <div v-if="badge.comment"
            class="mt-3 pt-3 border-t dark:border-gray-600 border-gray-300 text-sm dark:text-gray-400 text-gray-500 flex items-start gap-1.5">
...
const typePillClass = computed(() =>
    typeColors[props.badge.type] ?? 'bg-gray-200 text-gray-700 dark:bg-gray-600 dark:text-gray-300'
)
