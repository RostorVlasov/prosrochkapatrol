        ...
        <Transition name="modal-fade">
            <div v-if="model !== null"
                    ...
                    >
                        <SwiperSlide v-for="(img, idx) in images" :key="idx" class="flex items-center justify-center">
                            <div class="swiper-zoom-container w-full h-full flex items-center justify-center">
                                <NuxtImg format="webp" loading="lazy" quality="80" provider="freshapi" :src="buildImagePath(img.photo.url)"
                ...
                <div v-if="images.length > 1"
                    ...
                    <NuxtImg format="webp" loading="lazy" quality="80" provider="freshapi" v-for="(img, idx) in images" :key="idx"
                        :src="buildImagePath(img.photo.url)"
